...
abstract class ByteChannelSequentialBase(
    ...
    protected var closed by sharable(false)
    ...
    override var readByteOrder: ByteOrder by sharable(ByteOrder.BIG_ENDIAN)

    override var writeByteOrder: ByteOrder by sharable(ByteOrder.BIG_ENDIAN)
    ...
    final override var closedCause: Throwable? by sharable(null)
        private set
    ...
    private var lastReadAvailable by sharable(0)
    private var lastReadView: ChunkBuffer by sharable(ChunkBuffer.Empty)
