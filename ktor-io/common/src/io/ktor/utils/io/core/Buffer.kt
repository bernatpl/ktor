...
open class Buffer(val memory: Memory) {
     ...
     * and [reserveEndGap].
     */
    var readPosition by sharable(0)
        private set
     ...
     * and [reserveEndGap].
     */
    var writePosition by sharable(0)
        private set
     ...
     */
    var startGap: Int by sharable(0)
        private set
     ...
     */
    var limit: Int by sharable(memory.size32)
        private set
    ...
    @ExperimentalIoApi
    var attachment: Any? by sharable(null)
