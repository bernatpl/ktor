...
abstract class AbstractInput(
     ...
     */
    private final var __head: ChunkBuffer by sharable(head)
    ...
    @PublishedApi
    internal final var headMemory: Memory by sharable(head.memory)

    @PublishedApi
    internal final var headPosition by sharable(head.readPosition)

    @PublishedApi
    internal final var headEndExclusive by sharable(head.writePosition)
    ...
    private var _tailRemaining: Long by sharable(remaining - headRemaining)
